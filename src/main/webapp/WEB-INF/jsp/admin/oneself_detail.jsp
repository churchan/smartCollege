						...
						<form method="post" class="form-horizontal" action="">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									<a href="<%=path %>/personnel/oneself/<%=personnel.getId() %>/toUpdate.do" class="btn btn-primary">修&nbsp;&nbsp;改</a>&nbsp;&nbsp;
									<a href="<%=path %>/personnel/welcome.do" class="btn btn-info">返&nbsp;&nbsp;回</a>
								</div>
							</div>
						</form>
					</div>
