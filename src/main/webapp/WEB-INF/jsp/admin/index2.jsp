					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<span class="clear">
									<span  style="font-size: 12px; color: #7789b6;">
                                        <!--添加学院logo-->
										<img src=" ..\img\logo.png" width="177" height="64" />
										<p class="text-right">——智慧校园系统</p>
									</span>
								</span>
							</a>
						</div>
                   ...
                   <% Personnel personnel = (Personnel)session.getAttribute("loged"); %>
					<li><a href="graph_metrics.html">
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" href="<%=path %>/attendance/<%=personnel.getPersonnelNumber() %>/oneself.do">查看考勤记录</a>
							</li>
