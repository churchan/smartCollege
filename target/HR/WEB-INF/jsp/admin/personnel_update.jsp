...
<%@ page import="edu.tfswufe.entity.Position" %>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									%>
										...
										<%
											if(personnel.getDepartmentNumber().equals(department.getDepartmentNumber())){
										%>
											selected="selected"
										<%  }  %>
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="positionNumber" size="1" required>
										...
										%>
											...
											<%
												if(personnel.getPositionNumber().equals(position.getPositionNumber())){
											%>
												selected="selected"
											<%	}  %>
